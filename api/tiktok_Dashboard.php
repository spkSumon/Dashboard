...
<div class="sb-page">
    ...
    <p class="sb-title"><span>TikTok</span></p>
    <p class="sb-subtitle"><span>Sleep metrics naar het overzicht om te analyseren</span></p>
        ...
        <div class="sb-layout">
            ...
            <div class="sb-canvas <?= (!empty($metricsData) || !empty($metricErrors)) ? 'has-content' : '' ?>" id="dropZone">
                ...
                <?php if (!empty($metricErrors)): ?>
                    <div class="warning">
                        <strong><span>Metric geselecteerd, maar niet getoond:</span></strong>
                        <ul>
                            <?php foreach ($metricErrors as $mKey => $error): ?>
                                <li><strong><span><?= htmlspecialchars($mKey) ?>:</span></strong> <span><?= htmlspecialchars($error) ?></span></li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                <?php endif; ?>
                                ...
                                <div class="sb-card" style="--card-color: <?= $color ?>; --card-bg: <?= $bg ?>;">
                                    <div class="sb-card-header">
                                        ...
                                        <div class="sb-card-actions">
                                            ...
                                            <button type="button" class="sb-card-remove"
                                                    onclick="event.stopPropagation(); removeMetric('<?= htmlspecialchars($key) ?>')">
                                                <span>×</span>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sb-card-stats">
                                        ...
                                        <div class="sb-card-stat">
                                            ...
                                            <div class="sb-card-stat-value"><span><?= (int)$metric['data']['dataPointCount'] ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
